package addresswheel_master.view;
...
import com.fujisoft.campaign.AddAddressActivity;
import com.fujisoft.campaign.ApplyInvoiceActivity;
import com.fujisoft.campaign.R;
import com.fujisoft.campaign.ReleaseTaskActivity;

import java.util.List;

import addresswheel_master.adapter.AreaWheelAdapter;
import addresswheel_master.adapter.CityWheelAdapter;
import addresswheel_master.adapter.ProvinceWheelAdapter;
import addresswheel_master.model.AddressDtailsEntity.ProvinceEntity;
import addresswheel_master.model.AddressDtailsEntity.ProvinceEntity.CityEntity;
import addresswheel_master.utils.Utils;
import addresswheel_master.view.listener.OnAddressChangeListener;
import addresswheel_master.view.wheelview.MyOnWheelChangedListener;
import addresswheel_master.view.wheelview.MyWheelView;
import butterknife.Bind;
import butterknife.ButterKnife;
import butterknife.OnClick;


public class ChooseAddressWheelArea implements MyOnWheelChangedListener {
    ...
    public ChooseAddressWheelArea(Activity context) {
    ...
    private void initView() {
        parentView = layoutInflater.inflate(R.layout.choose_city, null);
        ButterKnife.bind(this, parentView);

        provinceWheel.setVisibleItems(7);
        cityWheel.setVisibleItems(7);
        districtWheel.setVisibleItems(View.GONE);
    ...
    public void setOnAddressChangeListener(AddAddressActivity onAddressChangeListener) {
        this.onAddressChangeListener = onAddressChangeListener;
    }

    public void setOnAddressChangeListener(ApplyInvoiceActivity onAddressChangeListener) {
        this.onAddressChangeListener = onAddressChangeListener;
    }

    public void setOnAddressChangeListener(ReleaseTaskActivity onAddressChangeListener) {
        this.onAddressChangeListener = onAddressChangeListener;
    }
